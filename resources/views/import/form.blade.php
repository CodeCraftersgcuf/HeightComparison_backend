...
<div class="container mt-5">
    ...
    <form id="import-form" action="{{ route('import.importData') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <small class="text-danger d-none" id="file-error">Invalid file format. Only JSON is allowed.</small>
        </div>
